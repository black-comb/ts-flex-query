...
export function and<TIn>(...operands: PipeOperator<TIn, boolean>[]): PipeOperator<TIn, boolean> {
  return reduceBooleanOperands('and', true, operands);
}

export function or<TIn>(...operands: PipeOperator<TIn, boolean>[]): PipeOperator<TIn, boolean> {
  return reduceBooleanOperands('or', false, operands);
}

export function not<TIn>(operand: PipeOperator<TIn, boolean>): PipeOperator<TIn, boolean> {
